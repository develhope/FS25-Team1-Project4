...
export default function HomeText() {
    return (
        <div className="helloworld-div p-[5%] w-full md:w-[70%] h-full flex flex-col justify-end animate-slideInLeft">
            <h1 className="text-white font-semibold text-4xl md:text-5xl lg:text-6xl 2xl:text-[5rem] break-words mb-[5%]">
                Let's Learn New Course <br /> <span className="inline-block">Gain More Skills</span>
            </h1>
            <span className="text-[#414b54] text-base md:text-lg lg:text-xl 2xl:text-[1.5rem] 2xl:leading-7 max-w-full">
