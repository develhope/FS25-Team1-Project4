...
import LessonsMenuCard from '../components/LessonsMenuCard';
        ...
        <div>
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 mt-52 mx-4 absolute">
                <LessonsMenuCard
                    ...
                    description={
                        'HTML è il linguaggio standard per creare pagine web, permettendo di strutturare testi, immagini e link in un formato leggibile e organizzato.'
                    }
                />
                <LessonsMenuCard
                    title={'CSS'}
                ...
                <LessonsMenuCard
                    ...
                    description={
                        'JavaScript porta le pagine web alla vita con interattività e dinamismo, permettendo agli sviluppatori di creare esperienze utente coinvolgenti e funzionali.'
                    }
                />
                <LessonsMenuCard
                    title={'Github'}
                    ...
                    description={
                        'GitHub è la piattaforma ideale per collaborare sul codice, gestire versioni e condividere progetti software con una community di sviluppatori globali.'
                    }
                />
                <LessonsMenuCard
                    title={'React'}
                    ...
                    description={
                        'React è una potente libreria JavaScript che facilita la costruzione di interfacce utente moderne e reattive, promuovendo componenti riutilizzabili e gestione efficiente.'
                    }
                    I
                />
            </div>
